...
if (process.env.INIT_DOCDB_CA_BUNDLE && user && password) {
    url = `mongodb://${user}:${password}@${host}:${port}/${database}?tls=true&tlsCAFile=/usr/src/app/init-micro-common/config/rds-combined-ca/rds-combined-ca-bundle.pem&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false`
