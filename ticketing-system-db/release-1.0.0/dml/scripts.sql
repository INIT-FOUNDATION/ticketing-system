...
INSERT INTO public.m_menus(menu_id, menu_name, menu_description, is_active, parent_menu_id, menu_order, route_url, icon_class, date_created, date_modified) VALUES (1, 'Dashboard', 'Admin Dashboard', 1, NULL, 0, '/dashboard', 'custom-admin-dashboard', NOW(), NOW());
