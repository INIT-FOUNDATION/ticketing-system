...
router.post("/updateUser", async (req, res) => {
    ...
    if (error) {
        ...
        userService.updateUser(user, userId, async (err, results) => {
            ...
            let preferred_state_id = req.body.preferred_state_id;
            let preferred_district_id = req.body.preferred_district_id;
            let preferred_zipcode = req.body.preferred_zipcode;
            if (req.body.preferred_state_id && req.body.preferred_district_id && req.body.preferred_zipcode) {
                await userService.updatePreferredLocationOfUser(userId, preferred_state_id, preferred_district_id, preferred_zipcode);
            }
